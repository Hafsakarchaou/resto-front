...
console.log("selectedSpecialite:", selectedSpecialite);
  ...
  const handleSpecialiteSelect = (selectedOption) => {
    ...
    <div className="container-xxl position-relative p-0">
        ...
        <div class="row g-3 d-flex  ">
          ...
          <SearchComponent  buttonTitle={selectedTitle} popupTitle="Choisir une Ville" options={ville.map(ville => ville.nom)} handleOptionSelect={handleVilleSelect}/>
            ...
            <div class="col-sm-4 col-12">
              <SearchComponent buttonTitle="Choisir une Specialite" popupTitle="Choisir une Specialite" options={specialite.map(specialite => specialite.nom)} handleOptionSelect={handleSpecialiteSelect}/>
  </div>
          </div>
        </div>
    </div>
...
export default RechercheParSpecialite